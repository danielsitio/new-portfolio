...
export default function Home() {
  ...
  function observar(e ){
    if(e.deltaY>0) document.getElementById("nav").classList.add("oculto")
    else document.getElementById("nav").classList.remove("oculto")
  }

  return (
    <div className={styles.container} onWheel={observar}>
      <Head>
        ...
        <main className={styles.main} >
          ...
          <section id="projects" className={`${styles.section} ${styles.projects}`}>
            ...
            <div className={styles.card_container}>
              ...
              <div className={styles.card}>
                <Image src="/rps.png" layout="responsive" width="5" height="3" className={styles.card_image}/>
                <div className={styles.card_text}>
                  <h3>Rock,Paper,Scissors </h3>
                  <p><FormattedMessage id="rps-description"/><a href="https://www.frontendmentor.io/" target="_blank" rel="noreferrer">Frontend Mentor</a>.</p>
                  
                </div>
                <div className={styles.card_links}>
                  <a href="https://rock-paper-scissor-opal.vercel.app/" target="_blank" rel="noreferrer"><FormattedMessage id="visit"/><FontAwesomeIcon icon={faExternalLinkAlt}/></a>
                </div>
              </div>
            </div>
          </section>
